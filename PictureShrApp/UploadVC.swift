...
class UploadVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        imageView.isUserInteractionEnabled = true         // kullanıcı işlem yapabilir hale getiriyoruz
        let gestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(gorselSec))         //jest algılayıcı
